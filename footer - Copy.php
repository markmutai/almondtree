    ...
    <div class="container tatwc-container md:max-w-xl lg:max-w-3xl xl:max-w-4xl">
        <div class="row">
            ...
            <div class="col-md-6 col-sm-12 phone:p-0 md:pl-10 md:mb-10 ftr-chunk rightie phone:text-xs md:text-mini lg:text-sm xl:text-tiny 2xl:text-base">
                <div class="top p-0">
                    <p class="phone:text-center md:text-right">
                        No. 2 Karigacha,
                        <br>
                        Off Dagoretti Road,
                        <br>
                    ...
                    <p class="time-dist phone:text-center md:text-right">
                        (3 min from The Hub)
                    </p>
                </div>
...
<script>
    ...
    if (($('html').hasClass('dark')) || window.matchMedia("(prefers-color-scheme: dark)")) {
