...
<head>
    ...
    <link rel="icon" type="image/jpg" href="<?php echo $sitelink ?>/favicon.jpg">
    <link rel="icon" sizes="192x192" href="<?php echo $sitelink ?>/faviconHighRes.jpg">
    ...
    <script src="<?php echo $sitelink ?>/app/js/bootstrap.min.js" type="text/javascript"></script>
    <script type="text/javascript" id="cookieinfo" src="<?php echo $sitelink ?>/app/js/cookieinfo.min.js" data-font-family="'Poppins', sans-serif" data-bg="#082702" data-fg="#FFFFFF" data-link="#2acc20" data-divlinkbg="#082000" data-divlink="#2acc20" data-cookie="CookieInfoScript" data-text-align="left" data-close-text="Close">
    </script>
    <script async defer>
